<?php
/**
 * Main template — single-page landing for HaveMyBurger Hotel.
 *
 * @package havemyburger
 */
?><!DOCTYPE html>
...
<?php wp_body_open(); ?>
    ...
    <div class="container">
      ...
      <div class="amenities__grid">
        <div class="amenity-card">
          <div class="amenity-card__icon">&#127946;</div>
          <h3>Rooftop Pool</h3>
          <p>Heated infinity pool with panoramic city views</p>
        </div>
        <div class="amenity-card">
          <div class="amenity-card__icon">&#128170;</div>
          <h3>Fitness Center</h3>
          <p>24-hour gym with personal training available</p>
        </div>
        <div class="amenity-card">
          <div class="amenity-card__icon">&#128133;</div>
          <h3>Spa &amp; Sauna</h3>
          <p>Full-service spa with massage and wellness treatments</p>
        </div>
        <div class="amenity-card">
          <div class="amenity-card__icon">&#128663;</div>
          <h3>Valet Parking</h3>
          <p>Complimentary valet and EV charging stations</p>
        </div>
        <div class="amenity-card">
          <div class="amenity-card__icon">&#128246;</div>
          <h3>Free Wi-Fi</h3>
          <p>High-speed fiber throughout the property</p>
        </div>
        <div class="amenity-card">
          <div class="amenity-card__icon">&#9749;</div>
          <h3>Room Service</h3>
          <p>Available 24/7 from our in-house kitchen</p>
        </div>
        <div class="amenity-card">
          <div class="amenity-card__icon">&#128188;</div>
          <h3>Business Lounge</h3>
          <p>Private meeting rooms and co-working space</p>
        </div>
        <div class="amenity-card">
          <div class="amenity-card__icon">&#128021;</div>
          <h3>Pet Friendly</h3>
          <p>We welcome your furry travel companions</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <footer class="footer">
    <div class="container footer__inner">
      <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo">HaveMy<span>Burger</span></a>
      <p class="footer__copy">&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> HaveMyBurger Hotel. All rights reserved.</p>
